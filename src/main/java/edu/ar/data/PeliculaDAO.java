...
public class PeliculaDAO {
  ...
  private static final String SQL_SELECT_BY_ID = "SELECT * FROM movies WHERE id_movie = ?";
  private static final String SQL_INSERT = 
  "INSERT INTO movies (nombre, descripcion, genero, calificacion, anio, estrellas, director) VALUES (?,?,?,?,?,?,?)";
  private static final String SQL_UPDATE = 
  "UPDATE movies SET nombre = ?, descripcion = ?, genero = ?, calificacion = ?, anio = ?, estrellas = ?, director = ? WHERE id_movie = ?";
  private static final String SQL_DELETE = "DELETE FROM movies WHERE id_movie = ?";
  ...
  public static List<Pelicula> obtener() {
    ...
    try {
      ...
      while (rs.next()) {
        ...
        pelicula = new Pelicula(id_movie,nombre,descripcion,genero,calificacion,anio,estrellas,director);
